...
@Slf4j
@Repository("inMemoryPasswordResetCodeRepository")
public class InMemoryPasswordResetCodeRepository implements PasswordResetCodeRepository {
    ...
    public InMemoryPasswordResetCodeRepository(
