    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(securityPathProperties.emailAuth().toArray(new String[0])).authenticated()
                        .requestMatchers(securityPathProperties.passwordReset().toArray(new String[0])).authenticated()
